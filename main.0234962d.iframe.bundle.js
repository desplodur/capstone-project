...
`;var jsx_runtime=__webpack_require__("./node_modules/react/jsx-runtime.js");function AnswerCard(_ref){let{children,...props}=_ref;return(0,jsx_runtime.jsx)(styled,{...props,children})}var Button=__webpack_require__("./src/components/Button/index.js"),Form=__webpack_require__("./src/components/Form/index.js");const StyledQuestionComponent=styled_components_browser_esm.ZP.section`
	position: relative;
	width: 90vw;
...
`;function QuestionComponent(_ref){let{question,...props}=_ref;const[toggle,setToggle]=(0,react.useState)(!0),[showEditQuestionForm,setShowEditQuestionForm]=(0,react.useState)(!1),answers=(0,useStore.o)((state=>state.answers.data)),setQuestion=(0,useStore.o)((state=>state.setQuestion)),addNewAnswer=(0,useStore.o)((state=>state.addNewAnswer)),activeUser=(0,useStore.o)((state=>state.activeUser));return(0,jsx_runtime.jsxs)(StyledQuestionComponent,{...props,children:[(0,jsx_runtime.jsxs)(StyledContent,{children:[showEditQuestionForm?(0,jsx_runtime.jsx)(Form.Z,{onSubmit:event=>{(event=>{event.preventDefault();const newQuestion=question;newQuestion.questionText=event.target.inputField.value,setQuestion(question._id,newQuestion),event.target.reset()})(event,question.id),setShowEditQuestionForm(!1)},placeholderText:question.questionText,submitButtonText:"->"}):(0,jsx_runtime.jsx)("h4",{children:question.questionText}),toggle?(0,jsx_runtime.jsx)("img",{id:"statusIndicator",src:question.answered?__webpack_require__("./src/utils/icons/statusClosed.svg").Z:__webpack_require__("./src/utils/icons/statusOpen.svg").Z,alt:question.answered?"Closed":"Open"}):(0,jsx_runtime.jsxs)(jsx_runtime.Fragment,{children:[question.userID===activeUser._id&&(0,jsx_runtime.jsxs)(jsx_runtime.Fragment,{children:[(0,jsx_runtime.jsx)(Button.Z,{id:"smallEditButton",editButtonSmall:!0,onClick:()=>{setShowEditQuestionForm(!showEditQuestionForm)},children:(0,jsx_runtime.jsx)("svg",{xmlns:"http://www.w3.org/2000/svg","aria-hidden":"true",role:"img",width:"4em",height:"4em",preserveAspectRatio:"xMidYMid meet",viewBox:"0 0 24 24",children:(0,jsx_runtime.jsxs)("g",{fill:"none",stroke:"currentColor",strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:"2",children:[(0,jsx_runtime.jsx)("path",{strokeDasharray:"20",strokeDashoffset:"20",d:"M3 21H21",children:(0,jsx_runtime.jsx)("animate",{fill:"freeze",attributeName:"stroke-dashoffset",dur:"0.3s",values:"20;0"})}),(0,jsx_runtime.jsx)("path",{strokeDasharray:"44",strokeDashoffset:"44",d:"M7 17V13L17 3L21 7L11 17H7",children:(0,jsx_runtime.jsx)("animate",{fill:"freeze",attributeName:"stroke-dashoffset",begin:"0.4s",dur:"0.6s",values:"44;0"})}),(0,jsx_runtime.jsx)("path",{strokeDasharray:"8",strokeDashoffset:"8",d:"M14 6L18 10",children:(0,jsx_runtime.jsx)("animate",{fill:"freeze",attributeName:"stroke-dashoffset",begin:"1s",dur:"0.2s",values:"8;0"})})]})})}),(0,jsx_runtime.jsx)(Button.Z,{id:"changeStatus",onClick:()=>{(()=>{const newQuestion=question;newQuestion.answered=!question.answered,console.log(newQuestion.answered),setQuestion(question._id,newQuestion)})(question.id),setToggle(!toggle)},children:(0,jsx_runtime.jsx)("img",{src:question.answered?__webpack_require__("./src/utils/icons/unCheck.svg").Z:__webpack_require__("./src/utils/icons/check.svg").Z,alt:question.answered?"Closed":"Open"})})]}),(0,jsx_runtime.jsx)("article",{children:answers.map((answer=>question._id===answer.questionID?(0,jsx_runtime.jsx)(AnswerCard,{children:answer.answerText},answer._id):null))}),(0,jsx_runtime.jsx)("article",{children:(0,jsx_runtime.jsx)(Form.Z,{onSubmit:event=>{(event=>{event.preventDefault();const newAnswer={answerText:event.target.inputField.value,questionID:question._id};addNewAnswer(newAnswer),event.target.reset()})(event)},placeholderText:"Type in your answer...",submitButtonText:"->"})})]})]}),(0,jsx_runtime.jsx)(Button.Z,{greyButton:!0,onClick:()=>{setToggle(!toggle)},children:toggle?"Show answers":"Hide answers"})]})}const Default=function Default(){return(0,jsx_runtime.jsx)(QuestionComponent,{children:"QuestionComponent"})},QuestionComponent_stories={title:"QuestionComponent",component:QuestionComponent};Default.parameters={storySource:{source:"function Default() {\n\treturn <QuestionComponent>QuestionComponent</QuestionComponent>;\n}"},...Default.parameters};const __namedExportsOrder=["Default"]},"./.storybook/preview.js-generated-config-entry.js":(__unused_webpack_module,__unused_webpack___webpack_exports__,__webpack_require__)=>{"use strict";var preview_namespaceObject={};__webpack_require__.r(preview_namespaceObject),__webpack_require__.d(preview_namespaceObject,{__namedExportsOrder:()=>__namedExportsOrder,decorators:()=>decorators,parameters:()=>parameters});var ClientApi=__webpack_require__("./node_modules/@storybook/client-api/dist/esm/ClientApi.js");const GlobalStyle=__webpack_require__("./node_modules/styled-components/dist/styled-components.browser.esm.js").vJ`
	*,
	*::before,
	*::after {
